...
class ResNet(nn.Module):
    def __init__(self, dataset, depth, num_classes, bottleneck=False, num_trans=16):
        ...
        if self.dataset.startswith('cifar'):
            ...
            self.fc2 = nn.Linear(64 * block.expansion, num_trans)
            self.lastdim = 64 * block.expansion
            ...
            self.fc2 = nn.Linear(512 * blocks[depth].expansion, num_trans)
            self.lastdim = 512 * blocks[depth].expansion
